// This creates dynamic magical boots
...
//Select boots to make//////////////////////////////////////////////////////////
{int nRandom = d10(1);
   if (nRandom == 1){SetLocalString(oPC, "enchant", "ench_boot_1");}
   else if (nRandom == 2){SetLocalString(oPC, "enchant", "ench_boot_2");}
   else if (nRandom == 3){SetLocalString(oPC, "enchant", "ench_boot_3");}
   else if (nRandom == 4){SetLocalString(oPC, "enchant", "ench_boot_4");}
   else if (nRandom == 5){SetLocalString(oPC, "enchant", "ench_boot_5");}
   else if (nRandom == 6){SetLocalString(oPC, "enchant", "ench_boot_6");}
   else if (nRandom == 7){SetLocalString(oPC, "enchant", "ench_boot_3");}
   else if (nRandom == 8){SetLocalString(oPC, "enchant", "ench_boot_4");}
   else if (nRandom == 9){SetLocalString(oPC, "enchant", "ench_boot_5");}
   else if (nRandom == 10){SetLocalString(oPC, "enchant", "ench_boot_6");}}
////////////////////////////////////////////////////////////////////////////////
...
{int nRandom = d2(1);
   ...
   else if (nRandom == 2){SetLocalInt(oPC, "enchfeat", IP_CONST_FEAT_DODGE);}}
////////////////////////////////////////////////////////////////////////////////
...
itemproperty propSavS = ItemPropertyBonusSavingThrowVsX(GetLocalInt(oPC, "enchsaves"), GetLocalInt(oPC, "enchatmod"));
...
itemproperty propACTyp = ItemPropertyACBonusVsDmgType(GetLocalInt(oPC, "enchdamtyp"), GetLocalInt(oPC, "enchatmod"));
...
object oArmor = CreateItemOnObject(GetLocalString(oPC, "enchant"), oPC, 1);
SetItemCharges(oArmor, 50);

//Add Spell Bonus
{int nRandom = d100(1);
if ((nRandom > 89) && (nRandom < 96)){IPSafeAddItemProperty(oArmor, propCast);}}
