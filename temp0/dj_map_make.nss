...
if (GetLocalInt(oPC, "mapallow") == 0){
    if (GetStringLeft(GetTag(oArea),8) == "TheAltar"){
        FloatingTextStringOnCreature("You decide not to map this area as it is too small to bother.", oPC, FALSE);}
...
if (GetTag(oArea) == "BrushwoodValley"){
    if (oIntel >= 17){
        ...
        {int nRandom = d4(1);
            if (nRandom == 1){
                FloatingTextStringOnCreature("You failed to make a map.  The paper is ruined.", oPC, FALSE);}
            else {
                SetLocalInt(oMap, "map001", 1);
                ExploreAreaForPlayer(oArea, oPC);
                FloatingTextStringOnCreature("You have successfully mapped Brushwood Valley.", oPC, FALSE);}}}
    ...
    if (oIntel >= 17){
        ...
        ExploreAreaForPlayer(oArea, oPC);
        FloatingTextStringOnCreature("You have successfully mapped the Bruol Bugbear Lair.", oPC, FALSE);}
    else if ((oIntel >= 12) && (oIntel <= 16)){
        {int nRandom = d4(1);
            if (nRandom == 1){
                FloatingTextStringOnCreature("You failed to make a map.  The paper is ruined.", oPC, FALSE);}
    ...
    if (oIntel >= 17){
        ...
        {int nRandom = d4(1);
            if (nRandom == 1){
                ...
                SetLocalInt(oMap, "map027", 1);
                ExploreAreaForPlayer(oArea, oPC);
                FloatingTextStringOnCreature("You have successfully mapped the Brakal's Tower.", oPC, FALSE);}}}
    else if (oIntel <= 11){
        {int nRandom = d2(1);
            if (nRandom == 1){
                FloatingTextStringOnCreature("You failed to make a map.  The paper is ruined.", oPC, FALSE);}
    ...
    if (oIntel >= 17){
        ...
        {int nRandom = d4(1);
            if (nRandom == 1){
                ...
                SetLocalInt(oMap, "map028", 1);
                ExploreAreaForPlayer(oArea, oPC);
                FloatingTextStringOnCreature("You have successfully mapped the Daclor's Crossing.", oPC, FALSE);}}}
    else if (oIntel <= 11){
        {int nRandom = d2(1);
            if (nRandom == 1){
                FloatingTextStringOnCreature("You failed to make a map.  The paper is ruined.", oPC, FALSE);}
    ...
    if (oIntel >= 17){
        ...
        ExploreAreaForPlayer(oArea, oPC);
        FloatingTextStringOnCreature("You have successfully mapped the Tower of the Silver Order.", oPC, FALSE);}
    else if ((oIntel >= 12) && (oIntel <= 16)){
        {int nRandom = d4(1);
            if (nRandom == 1){
                FloatingTextStringOnCreature("You failed to make a map.  The paper is ruined.", oPC, FALSE);}
    ...
    if (oIntel >= 17){
        ...
        {int nRandom = d4(1);
            if (nRandom == 1){
                ...
                SetLocalInt(oMap, "map058", 1);
                ExploreAreaForPlayer(oArea, oPC);
                FloatingTextStringOnCreature("You have successfully mapped the Shira's Web.", oPC, FALSE);}}}
    else if (oIntel <= 11){
        {int nRandom = d2(1);
            if (nRandom == 1){
                FloatingTextStringOnCreature("You failed to make a map.  The paper is ruined.", oPC, FALSE);}
    ...
    if (oIntel >= 17){
        ...
        {int nRandom = d4(1);
            if (nRandom == 1){
                ...
                SetLocalInt(oMap, "map059", 1);
                ExploreAreaForPlayer(oArea, oPC);
                FloatingTextStringOnCreature("You have successfully mapped the Melagan Jungle.", oPC, FALSE);}}}
    else if (oIntel <= 11){
        {int nRandom = d2(1);
            if (nRandom == 1){
                FloatingTextStringOnCreature("You failed to make a map.  The paper is ruined.", oPC, FALSE);}
    ...
    if (oIntel >= 17){
        ...
        ExploreAreaForPlayer(oArea, oPC);
        FloatingTextStringOnCreature("You have successfully mapped the Tower of the Damned", oPC, FALSE);}
    else if ((oIntel >= 12) && (oIntel <= 16)){
        {int nRandom = d4(1);
            if (nRandom == 1){
                FloatingTextStringOnCreature("You failed to make a map.  The paper is ruined.", oPC, FALSE);}
