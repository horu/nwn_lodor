...
void main()
{
    ...
    if (GetTag(OBJECT_SELF) == "trg_climb_1")
    {
        ...
        else
        {
            FloatingTextStringOnCreature(
                "If you had a rope, you could probably use it to climb down this hole.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_2")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "If you had a rope, you could probably use it to climb down this icy chasm.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_3")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "You could probably use your rope to climb down the side of Brakal's Tower.",
                oPC,
                FALSE);
        }
        else
        {
            FloatingTextStringOnCreature(
                "If you had a rope, you could probably use it to climb down the side of Brakal's Tower.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_4")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "If you had a rope, you could probably use it to climb down this ledge.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_5")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "You see a ledge above you that you could get to if you had a rope.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_6")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "If you had a rope, you could probably descend into the depths below.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_9")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "If you use your rope, you can wrap it around that tree on the other side.",
                oPC,
                FALSE);
        }
        else
        {
            FloatingTextStringOnCreature(
                "If you had a rope, you could wrap it around that tree on the other side.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_13")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "You can see the cliff above.  Your rope can help you scale the sides.",
                oPC,
                FALSE);
        }
        else
        {
            FloatingTextStringOnCreature(
                "You can see the cliff above.  A rope could help you scale the sides.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_14")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "You can see a castle on the cliff above.  Your rope can help you scale the sides.",
                oPC,
                FALSE);
        }
        else
        {
            FloatingTextStringOnCreature(
                "You can see a castle on the cliff above.  A rope could help you scale the sides.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_15")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "You can see the Shifting Growth below.  Your rope can help you climb down.",
                oPC,
                FALSE);
        }
        else
        {
            FloatingTextStringOnCreature(
                "You can see the Shifting Growth below.  A rope could help you climb down.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_16")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "You can see the cavern floor below.  Your rope can help you climb down.",
                oPC,
                FALSE);
        }
        else
        {
            FloatingTextStringOnCreature(
                "You can see the cavern floor below.  A rope could help you climb down.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_17")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "You can see some ruins on the cliffs above.  Your rope can help you climb these cliffs.",
                oPC,
                FALSE);
        }
        else
        {
            FloatingTextStringOnCreature(
                "You can see some ruins on the cliffs above.  A rope could help you climb these cliffs.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_18")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "You can see the forest below.  Your rope can help you climb down this cliff.",
                oPC,
                FALSE);
        }
        else
        {
            FloatingTextStringOnCreature(
                "You can see the forest below.  A rope could help you climb down this cliff.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_24")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "You can see trees above you.  Your rope could help you get up there.",
                oPC,
                FALSE);
        }
        else
        {
            FloatingTextStringOnCreature(
                "You can see trees above you.  A rope could help you get up there.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_25")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "The bridge that was here has been removed.  Perhaps your rope can get you across.",
                oPC,
                FALSE);
        }
        else
        {
            FloatingTextStringOnCreature(
                "The bridge that was here has been removed.  Perhaps a rope could get you across.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_28")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "You can see the forest floor below.  Your rope can help you climb down.",
                oPC,
                FALSE);
        }
        else
        {
            FloatingTextStringOnCreature(
                "You can see the forest floor below.  A rope could help you climb down.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_29")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "You notice a tree fort above you.  Your rope could help you climb up.",
                oPC,
                FALSE);
        }
        else
        {
            FloatingTextStringOnCreature(
                "You notice a tree fort above you.  A rope could help you climb up.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_30")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "You can see the poisonous bog below.  Your rope can help you get down.",
                oPC,
                FALSE);
        }
        else
        {
            FloatingTextStringOnCreature(
                "You can see the poisonous bog below.  A rope could help you get down.",
                oPC,
                FALSE);
        }
    }
    ...
    else if (GetTag(OBJECT_SELF) == "trg_climb_31")
    {
        ...
        {
            FloatingTextStringOnCreature(
                "You can barely see a house on the mountain above.  Your rope can help you scale the sides.",
                oPC,
                FALSE);
        }
        else
        {
            FloatingTextStringOnCreature(
                "You can barely see a house on the mountain above.  A rope could help you scale the sides.",
                oPC,
                FALSE);
        }
    }
