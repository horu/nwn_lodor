    ...
    if ((GetAlignmentGoodEvil(oPC) == ALIGNMENT_NEUTRAL) || (GetAlignmentLawChaos(oPC) == ALIGNMENT_NEUTRAL)){
        if(GetHitDice(oPC) <= 4){
            ...
            if((!HasItem(oPC, "altar_quest_leaf")) == FALSE){
                ...
                string sSayThis = "You are now a child of Calyril. Wear this ring and never remove it from your hand. Serve me well.";
                SpeakString(sSayThis);}
            else {
...
// Beginning of the section for Fradoc /////////////////////////////////////////////////////
        ...
        if(GetHitDice(oPC) <= 4){
            ...
            if((!HasItem(oPC, "alter_quest_burlop")) == FALSE){
                ...
                ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_BIGBYS_FORCEFUL_HAND), oPC);
                string sSayThis = "You are now a disciple of Fradoc. Wear this ring and never remove it from your hand. Serve me well.";
                SpeakString(sSayThis);}
            else {
            ...
            if((!HasItem(oPC, "altar_quest_cal6")) == FALSE){
                ...
                SetLocalInt(oQuest, "qs1d2", 1);
                string sSayThis = "You must first take Samtharia's Scroll of Ice Fall from her cold dead hands.  That witch lives to the north.";
                SpeakString(sSayThis);}}
    }
...
// Beginning of the section for Shyvaa /////////////////////////////////////////////////////
        ...
        if(GetHitDice(oPC) <= 4){
            ...
            if((!HasItem(oPC, "alter_qst_shyva1")) == FALSE){
                ...
                ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_BIGBYS_FORCEFUL_HAND), oPC);
                string sSayThis = "You are now a disciple of Shyvaa. Wear this ring and never remove it from your hand. Serve me well.";
                SpeakString(sSayThis);}
            else {
...
// Beginning of the section for Somry /////////////////////////////////////////////////////
        ...
        if(GetHitDice(oPC) <= 4){
            ...
            if((!HasItem(oPC, "alter_qst_somry1")) == FALSE){
                ...
                ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_BIGBYS_FORCEFUL_HAND), oPC);
                string sSayThis = "You are now a disciple of Somry. Wear this ring and never remove it from your hand. Serve me well.";
                SpeakString(sSayThis);}
            else {
...
// Beginning of the section for Oweodd /////////////////////////////////////////////////////
        ...
        if(GetHitDice(oPC) <= 4){
            ...
            if((!HasItem(oPC, "reagnt_mephit")) == FALSE){
                ...
                ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_BIGBYS_FORCEFUL_HAND), oPC);
                string sSayThis = "You are now a disciple of Oweodd. Wear this ring and never remove it from your hand. Serve me well.";
                SpeakString(sSayThis);}
            else {
...
// Beginning of the section for Unur ///////////////////////////////////////////////////////
        ...
        if(GetHitDice(oPC) <= 4){
            ...
            if((!HasItem(oPC, "harpy_egg")) == FALSE){
                ...
                ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_BIGBYS_FORCEFUL_HAND), oPC);
                string sSayThis = "You are now a disciple of Unur. Wear this ring and never remove it from your hand. Serve me well.";
                SpeakString(sSayThis);}
            else {
...
if (GetLevelByClass(CLASS_TYPE_DIVINECHAMPION, oPC) > 0){
        ...
        if(GetHitDice(oPC) <= 4){
            ...
            if((!HasItem(oPC, "alter_qst_torm1")) == FALSE){
                ...
                CreateItemOnObject("ring_torm1", oPC, 1);
                ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_BIGBYS_FORCEFUL_HAND), oPC);
                string sSayThis = "You are now a child of Torm. Wear this ring and never remove it from your hand. Serve me well.";
                SpeakString(sSayThis);}
            else {
...
if (GetAlignmentGoodEvil(oPC) == ALIGNMENT_EVIL){
        if(GetHitDice(oPC) <= 4){
            ...
            if((!HasItem(oPC, "alter_qst_malad1")) == FALSE){
                ...
                ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_BIGBYS_FORCEFUL_HAND), oPC);
                string sSayThis = "You are now a servant of Malad. Wear this ring and never remove it from your hand. Serve me well.";
                SpeakString(sSayThis);}
            else {
            ...
            if((!HasItem(oPC, "alter_qst_malad4")) == FALSE){
                ...
                SetLocalInt(oQuest, "qs1d8", 1);
                string sSayThis = "You must first slay the Demon of the Well, Radhael.  Bring his hand to me."; //Well of Souls
                SpeakString(sSayThis);}}
    }
    else {
...
if (GetAlignmentGoodEvil(oPC) == ALIGNMENT_EVIL){
        if(GetHitDice(oPC) <= 4){
            ...
            if((!HasItem(oPC, "alter_qst_belul1")) == FALSE){
                ...
                ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_BIGBYS_FORCEFUL_HAND), oPC);
                string sSayThis = "You are now a servant of Belulas. Wear this ring and never remove it from your hand. Serve me well.";
                SpeakString(sSayThis);}
            else {
            ...
            if((!HasItem(oPC, "alter_qst_belul4")) == FALSE){
                ...
                SetLocalInt(oQuest, "qs1d9", 1);
                string sSayThis = "Seek the dragon known as Rhaizhizth.  Destroy him and bring me his claw."; //Gold Dragon
                SpeakString(sSayThis);}}
    }
    else {
    string sSayThis = "Your virtues disgust me!  Leave this place!";
...
// Beginning of the section for Puril //////////////////////////////////////////////////////
        ...
        if(GetHitDice(oPC) <= 4){
            ...
            if((!HasItem(oPC, "alter_qst_puril2")) == FALSE){
                ...
                ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_BIGBYS_FORCEFUL_HAND), oPC);
                string sSayThis = "You are now a disciple of Puril. Wear this ring and never remove it from your hand. Serve me well.";
                SpeakString(sSayThis);}
            else {
            ...
            if((!HasItem(oPC, "alter_qst_puril1")) == FALSE){
                ...
                SetLocalInt(oQuest, "qs1d10", 1);
                string sSayThis = "You must first bring me the Talisman Of The Spider.  The driders have taken it.";  //This is in THE UNDER PASSAGE
                SpeakString(sSayThis);}}
        else if((GetHitDice(oPC) >= 15) && (GetHitDice(oPC) <= 19)){
...
// Beginning of the section for Rimyr //////////////////////////////////////////////////////
        ...
        if(GetHitDice(oPC) <= 4){
            ...
            if((!HasItem(oPC, "alter_qst_rimyr1")) == FALSE){
                ...
                ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_BIGBYS_FORCEFUL_HAND), oPC);
                string sSayThis = "You are now a disciple of Rimyr. Wear this ring and never remove it from your hand. Serve me well.";
                SpeakString(sSayThis);}
            else {
            ...
            if((!HasItem(oPC, "alter_qst_rimyr2")) == FALSE){
                ...
                SetLocalInt(oQuest, "qs1d11", 1);
                string sSayThis = "You must bring me the Sword of Dareg, who was slain by Horfilad.";  //This is in Horfilad Manor
                SpeakString(sSayThis);}}
        else if((GetHitDice(oPC) >= 15) && (GetHitDice(oPC) <= 19)){
...
if (GetAlignmentLawChaos(oPC) == ALIGNMENT_LAWFUL){
        if(GetHitDice(oPC) <= 4){
            ...
            if((!HasItem(oPC, "alter_qst_uroni1")) == FALSE){
                ...
                ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_BIGBYS_FORCEFUL_HAND), oPC);
                string sSayThis = "You are now a child of Uronia. Wear this ring and never remove it from your hand. Serve me well.";
                SpeakString(sSayThis);}
            else {
            ...
            if((!HasItem(oPC, "alter_qst_uroni2")) == FALSE){
                ...
                SetLocalInt(oQuest, "qs1d12", 1);
                string sSayThis = "You must seek the Cloak of Uronia from once kind ruler of the Dedry Kingdom known as Yarbek.";  //Dedry Catacombs
                SpeakString(sSayThis);}}
        else if((GetHitDice(oPC) >= 15) && (GetHitDice(oPC) <= 19)){
            ...
            if((!HasItem(oPC, "alter_qst_uroni4")) == FALSE){
                ...
                SetLocalInt(oQuest, "qs1d12", 1);
                string sSayThis = "Seek the wizard Glomarin and send his soul back to his crystal prison.  Then bring his ring to me.";
                SpeakString(sSayThis);}}
    }
    else {
