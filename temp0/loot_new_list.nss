    ...
    {
        {
            ...
            else if (nRandom == 2) { CreateItemOnObject("lodoc_ffield", OBJECT_SELF, 1); }
            //Fire Field             960GP
            else if (nRandom == 3) { CreateItemOnObject("lodoc_grestore", OBJECT_SELF, 1); }
            //Greater Restoration   1821GP
            else if (nRandom == 4) { CreateItemOnObject("lodoc_stoneskin2", OBJECT_SELF, 1); }
            //Greater Stoneskin     1320GP
            else if (nRandom == 5) { CreateItemOnObject("lodoc_medicine", OBJECT_SELF, 1); }
            //Medicine               200GP
            else if (nRandom == 6) { CreateItemOnObject("lodoc_lightp", OBJECT_SELF, 1); }
            //Nightsight              50GP
            else if (nRandom == 7) { CreateItemOnObject("lodoc_polymph", OBJECT_SELF, 1); }
            //Polymorph              560GP
            else if (nRandom == 8) { CreateItemOnObject("lodoc_rage", OBJECT_SELF, 1); } //Rage                   120GP
            else if (nRandom == 9) { CreateItemOnObject("lodoc_shpchng", OBJECT_SELF, 1); }
            //Shape Change          3061GP
            else if (nRandom == 10) { CreateItemOnObject("lodoc_stoneskin", OBJECT_SELF, 1); }
            //Stoneskin              560GP
            else if (nRandom == 11) { CreateItemOnObject("lodoc_preserve", OBJECT_SELF, 1); }
            //Preservation          5976GP
        }
    }
    ...
    {
        {
            ...
            else if ((nRandom == 4) || (nRandom == 5)) { CreateItemOnObject("reagnt_bflow", OBJECT_SELF, 1); }
            //Belan Flower
            else if ((nRandom == 6) || (nRandom == 7)) { CreateItemOnObject("lodoc_bottle", OBJECT_SELF, 1); } //Bottle
            else if ((nRandom == 8) || (nRandom == 9)) { CreateItemOnObject("reagnt_bliquid", OBJECT_SELF, 1); }
            //Burning Liquid
            else if ((nRandom == 10) || (nRandom == 11)) { CreateItemOnObject("reagnt_dbranch", OBJECT_SELF, 1); }
            //Deru Branch
            else if ((nRandom == 12) || (nRandom == 13)) { CreateItemOnObject("reagnt_glic", OBJECT_SELF, 1); } //Garlic
            else if ((nRandom == 14) || (nRandom == 15)) { CreateItemOnObject("reagnt_mshards", OBJECT_SELF, 1); }
            //Metal Shards
            else if ((nRandom == 16) || (nRandom == 17)) { CreateItemOnObject("lodoc_pwdbag", OBJECT_SELF, 1); }
            //Powder Bag
            else if ((nRandom == 18) || (nRandom == 19)) { CreateItemOnObject("reagnt_therb", OBJECT_SELF, 1); }
            //Trampul Herb
            else if ((nRandom == 20) || (nRandom == 21)) { CreateItemOnObject("reagnt_tntpwdr", OBJECT_SELF, 1); }
            //Treant Powder
            else if ((nRandom == 22) || (nRandom == 23)) { CreateItemOnObject("reagnt_batwing", OBJECT_SELF, 1); }
            //Bat Wing
            else if ((nRandom == 24) || (nRandom == 25)) { CreateItemOnObject("gazer_eye", OBJECT_SELF, 1); }
            //Gazer Eye
            else if ((nRandom == 26) || (nRandom == 27)) { CreateItemOnObject("harpy_egg", OBJECT_SELF, 1); }
            //Harpy Egg
            else if ((nRandom == 28) || (nRandom == 29)) { CreateItemOnObject("reagnt_lavarock", OBJECT_SELF, 1); }
            //Lava Rock
            else if ((nRandom == 30) || (nRandom == 31)) { CreateItemOnObject("ld_mush_spore", OBJECT_SELF, 1); }
            //Mushroom Spore
            else if ((nRandom == 32) || (nRandom == 33)) { CreateItemOnObject("reagnt_mephit", OBJECT_SELF, 1); }
            //Mephit Wing
            ...
            else if ((nRandom > 1) && (nRandom < 34)) { CreateItemOnObject("x2_it_cfm_pbottl", OBJECT_SELF, 1); }
            //Empty Potion Bottle
        }
    }
