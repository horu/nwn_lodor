    ...
    {int nRandom = d10(1);
        if (nRandom == 1){
            ...
            if (nRandom == 1){
                ...
                FloatingTextStringOnCreature("You dug up a greenstone and put it in your pack.", oPC, FALSE);}
            else if (nRandom == 2){
                CreateItemOnObject("NW_IT_GEM007", oPC, 1);
                FloatingTextStringOnCreature("You dug up some malachite and put it in your pack.", oPC, FALSE);}
            else if (nRandom == 3){
                CreateItemOnObject("NW_IT_GEM002", oPC, 1);
                FloatingTextStringOnCreature("You dug up a fire agate and put it in your pack.", oPC, FALSE);}
            else if (nRandom == 4){
                ...
                FloatingTextStringOnCreature("You dug up an aventuring and put it in your pack.", oPC, FALSE);}
            else if (nRandom == 6){
    ...
    {int nRandom = d10(1);
        if ((nRandom > 0) && (nRandom < 4)){
            ...
            if (nRandom == 1){
                ...
                FloatingTextStringOnCreature("You dug up some alexandrite and put it in your pack.", oPC, FALSE);}
            else if (nRandom == 3){
    ...
    {int nRandom = d10(1);
        if (nRandom < 4){
            ...
            if (nRandom == 1){
                ...
                FloatingTextStringOnCreature("You dug up a blue light gem and put it in your pack.", oPC, FALSE);}
            else if (nRandom == 2){
                CreateItemOnObject("x2_it_lightgem005", oPC, 1);
                FloatingTextStringOnCreature("You dug up a green light gem and put it in your pack.", oPC, FALSE);}
            else if (nRandom == 3){
               CreateItemOnObject("x2_it_lightgem006", oPC, 1);
                FloatingTextStringOnCreature("You dug up a orange light gem and put it in your pack.", oPC, FALSE);}
            else if (nRandom == 4){
                CreateItemOnObject("x2_it_lightgem003", oPC, 1);
               FloatingTextStringOnCreature("You dug up a purple light gem and put it in your pack.", oPC, FALSE);}
            else if (nRandom == 5){
                CreateItemOnObject("x2_it_lightgem004", oPC, 1);
                FloatingTextStringOnCreature("You dug up a red light gem and put it in your pack.", oPC, FALSE);}
            else if (nRandom == 6){
                CreateItemOnObject("x2_it_lightgem007", oPC, 1);
                FloatingTextStringOnCreature("You dug up a white light gem and put it in your pack.", oPC, FALSE);}
            else if (nRandom == 7){
                CreateItemOnObject("x2_it_lightgem002", oPC, 1);
                FloatingTextStringOnCreature("You dug up a yellow light gem and put it in your pack.", oPC, FALSE);}
            else if (nRandom == 8){
                CreateItemOnObject("NW_IT_GEM009", oPC, 1);
                FloatingTextStringOnCreature("You dug up a fire opal and put it in your pack.", oPC, FALSE);}
            }}
