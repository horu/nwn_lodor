...
void main()
{
    ...
    if (GetLocalInt(oItem1, "insured") == 1) { SetCustomToken(169, sSay); }
    else { SetCustomToken(169, ""); }
    if (GetLocalInt(oItem3, "insured") == 1) { SetCustomToken(170, sSay); }
    else { SetCustomToken(170, ""); }
    if (GetLocalInt(oItem5, "insured") == 1) { SetCustomToken(171, sSay); }
    else { SetCustomToken(171, ""); }
    if (GetLocalInt(oItem7, "insured") == 1) { SetCustomToken(172, sSay); }
    else { SetCustomToken(172, ""); }
    if (GetLocalInt(oItem8, "insured") == 1) { SetCustomToken(173, sSay); }
    else { SetCustomToken(173, ""); }
    if (GetLocalInt(oItem9, "insured") == 1) { SetCustomToken(174, sSay); }
    else { SetCustomToken(174, ""); }
    if (GetLocalInt(oItem10, "insured") == 1) { SetCustomToken(175, sSay); }
    else { SetCustomToken(175, ""); }
    if (GetLocalInt(oItem11, "insured") == 1) { SetCustomToken(176, sSay); }
    else if (GetStringLeft(GetTag(oItem11), 8) == "POW_ring") { SetCustomToken(176, sRing); }
    else { SetCustomToken(176, ""); }
    if (GetLocalInt(oItem12, "insured") == 1) { SetCustomToken(177, sSay); }
    else { SetCustomToken(177, ""); }
    if (GetLocalInt(oItem13, "insured") == 1) { SetCustomToken(178, sSay); }
    else { SetCustomToken(178, ""); }
    if (GetLocalInt(oItem14, "insured") == 1) { SetCustomToken(179, sSay); }
    else if (GetStringLeft(GetTag(oItem14), 8) == "POW_ring") { SetCustomToken(179, sRing); }
    else { SetCustomToken(179, ""); }
}
