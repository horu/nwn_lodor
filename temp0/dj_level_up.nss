            ...
            if ((GetHitDice(oPC) == 5) || (GetHitDice(oPC) == 10) || (GetHitDice(oPC) == 15) || (GetHitDice(oPC) == 20))
            {
                if (GetDeity(oPC) == "Belulas")
                {
                    ...
                    FloatingTextStringOnCreature(
                        "Return to the Altar of Belulas to receive your blessing.",
                        oPC,
                        FALSE);
                }
                ...
                else if (GetDeity(oPC) == "Calyril")
                {
                    ...
                    AssignCommand(oPC, ClearAllActions());
                    FloatingTextStringOnCreature(
                        "Return to the Altar of Calyril to receive your blessing.",
                        oPC,
                        FALSE);
                }
        ...
        else
        {
            if (GetHitDice(oPC) == 5)
            {
                ...
                itemproperty spriteSp2 = ItemPropertyCastSpell(
                    ...
                    IP_CONST_CASTSPELL_NUMUSES_2_USES_PER_DAY);
                itemproperty spriteSp3 = ItemPropertyCastSpell(
            ...
            if (GetHitDice(oPC) == 20)
            {
                ...
                itemproperty spriteSp3 = ItemPropertyCastSpell(
                    IP_CONST_CASTSPELL_UNIQUE_POWER,
                    IP_CONST_CASTSPELL_NUMUSES_UNLIMITED_USE);
                itemproperty spriteSp4 = ItemPropertyCastSpell(
