...
/*56*/
int COLOR_SILVER = TRUE;
/*57*/
int COLOR_OBSIDIAN = TRUE;
/*58*/
int COLOR_GOLD = TRUE;
/*59*/
int COLOR_COPPER = TRUE;
/*60*/
int COLOR_GREY = TRUE;
/*61*/
int COLOR_MIRROR = TRUE;
/*62*/
int COLOR_WHITE = TRUE;
/*63*/
int COLOR_BLACK = TRUE;
...
void ShowDyeKitColorStatus(object oPlayer)
{
    ...
    string sMessage = "<cžžž>Original[" + IntToString(iOriginalColor) + "]</c>  <cþþþ>Current: [" + IntToString(
        iCurrentColor) + "]</c>";
...
void EnableDyeKitMenu()
{
    ...
    if (sTag == "UDK")
    {
        ...
        AssignCommand(oActivator, ActionStartConversation(oActivator, "udk_dialog", TRUE));
    }
}
