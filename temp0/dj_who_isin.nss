...
string GetClassLevels(object oPC)
{
    ...
    for (iClsIdx = 1; iClsIdx <= 3; iClsIdx++)
    {
        ...
        if (iClsType != CLASS_TYPE_INVALID)
        {
            switch (iClsType)
            {
            case CLASS_TYPE_BARBARIAN: sClsName = "Bbn";
                break;
            case CLASS_TYPE_BARD: sClsName = "Brd";
                break;
            case CLASS_TYPE_CLERIC: sClsName = "Clr";
                break;
            case CLASS_TYPE_DRUID: sClsName = "Drd";
                break;
            case CLASS_TYPE_FIGHTER: sClsName = "Ftr";
                break;
            case CLASS_TYPE_MONK: sClsName = "Mnk";
                break;
            case CLASS_TYPE_PALADIN: sClsName = "Pal";
                break;
            case CLASS_TYPE_RANGER: sClsName = "Rgr";
                break;
            case CLASS_TYPE_ROGUE: sClsName = "Rog";
                break;
            case CLASS_TYPE_SORCERER: sClsName = "Sor";
                break;
            case CLASS_TYPE_WIZARD: sClsName = "Wiz";
                break;
            case CLASS_TYPE_ARCANE_ARCHER: sClsName = "Arc";
                break;
            case CLASS_TYPE_BLACKGUARD: sClsName = "Blk";
                break;
            case CLASS_TYPE_HARPER: sClsName = "Hrp";
                break;
            case CLASS_TYPE_SHADOWDANCER: sClsName = "Shd";
                break;
            case CLASS_TYPE_WEAPON_MASTER: sClsName = "Wep";
                break;
            case CLASS_TYPE_SHIFTER: sClsName = "Shf";
                break;
            case CLASS_TYPE_PALEMASTER: sClsName = "Plm";
                break;
            case CLASS_TYPE_DWARVENDEFENDER: sClsName = "Dwv";
                break;
            case CLASS_TYPE_DRAGONDISCIPLE: sClsName = "Drg";
                break;
            case CLASS_TYPE_DIVINECHAMPION: sClsName = "Chp";
                break;
