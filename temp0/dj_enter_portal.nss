...
if (GetRacialType(oPC) == RACIAL_TYPE_HALFLING){
    ...
    else if ((GetSubRace(oPC) == "Sylvan") || (GetSubRace(oPC) == "SYLVAN") || (GetSubRace(oPC) == "sylvan")){
        if((GetLevelByClass(CLASS_TYPE_BARBARIAN, oPC) > 0) ||
    ...
    if ((GetSubRace(oPC) == "Quickling") || (GetSubRace(oPC) == "quickling") || (GetSubRace(oPC) == "QUICKLING")){
     ...
     else if ((GetSubRace(oPC) == "Sprite") || (GetSubRace(oPC) == "sprite") || (GetSubRace(oPC) == "SPRITE")){
       ...
       if (nQSprite == 0){BootPC(oPC);}
        ...
        if((GetLevelByClass(CLASS_TYPE_ARCANE_ARCHER, oPC) > 0) ||
           ...
           (GetLevelByClass(CLASS_TYPE_MONK, oPC) > 0)){BootPC(oPC);}
              ...
              itemproperty spriteSp1 = ItemPropertyCastSpell(IP_CONST_CASTSPELL_CHARM_PERSON_2, IP_CONST_CASTSPELL_NUMUSES_1_USE_PER_DAY);
              itemproperty spriteSp2 = ItemPropertyCastSpell(IP_CONST_CASTSPELL_SLEEP_2, IP_CONST_CASTSPELL_NUMUSES_1_USE_PER_DAY);
