...
void main()
{
    ...
    if (GetIsPC(oKiller) == TRUE)
    {
        ...
        else if ((GetStringLeft(GetTag(OBJECT_SELF), 9) == "LD_BANDIT") || (GetStringLeft(GetTag(OBJECT_SELF), 9) ==
            "DJ_BANDIT"))
        {
            if (GetSubRace(oKiller) != "Vampire")
            {
        ...
        else if (GetTag(OBJECT_SELF) == "LD_COLLECT")
        {
            ...
            ApplyEffectAtLocation(
                ...
                GetLocation(GetWaypointByTag("demon_portal1")));
        }
        ...
        else if (GetTag(OBJECT_SELF) == "ld_radhael")
        {
            ...
            ApplyEffectAtLocation(
                DURATION_TYPE_INSTANT,
                EffectVisualEffect(VFX_FNF_FIRESTORM),
                GetLocation(GetWaypointByTag("demon_portal2")));
        }
        ...
        else if ((GetTag(OBJECT_SELF) == "LD_OGRELORD") || (GetTag(OBJECT_SELF) == "LD_OGRECHIEF") || (GetTag(
            OBJECT_SELF) == "LD_VAULTOGRE"))
        {
