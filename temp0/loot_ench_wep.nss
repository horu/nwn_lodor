...
int GetOnHitSpecial(int on_hit_prop)
{
...
int GetCastSpellNum(int modify_12)
{
...
void main()
{
    ...
    {
        int on_hit_prop = GetOnHitProp();
        itemproperty prop = ItemPropertyOnHitProps(on_hit_prop, GetOnHitSaveDc(level), GetOnHitSpecial(on_hit_prop));
        IPSafeAddItemProperty(weapon, prop);
    }
    else if (d100(1) <= chance_on_hit)
    {
        itemproperty prop = ItemPropertyOnHitCastSpell(GetOnHitCastSpell(), level);
        IPSafeAddItemProperty(weapon, prop);
    }
    ...
    else if (d100(1) <= chance)
    {
        ...
        itemproperty prop = ItemPropertyCastSpell(GetCastSpell(level), GetCastSpellNum(modify_12));
        IPSafeAddItemProperty(weapon, prop);
    }
