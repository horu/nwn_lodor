...
itemproperty vampireAbil14 = ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_FIRE, IP_CONST_DAMAGEVULNERABILITY_50_PERCENT);
itemproperty vampireAbil15 = ItemPropertyDamageVulnerability(IP_CONST_DAMAGETYPE_POSITIVE, IP_CONST_DAMAGEVULNERABILITY_75_PERCENT);
...
itemproperty vampireAbil18 = ItemPropertyDamageResistance(IP_CONST_DAMAGETYPE_ELECTRICAL, IP_CONST_DAMAGERESIST_20);
...
// QUEST 1I  --  Advanced Armor Craft
  ...
  if((!HasItem(oPC, "qs1i_item")) == FALSE){
    string sText = "I thank you.  As I promised, I have written all my secrets in this book for you.  Farewell.";
    ActionSpeakString(sText);
...
// QUEST 1K  --  Magic Boots
  ...
  if((GetItemPossessedBy(oPC, "ld_drgn_hide_blk") != OBJECT_INVALID) ||
    ...
    (GetItemPossessedBy(oPC, "ld_drgn_hide_psm") != OBJECT_INVALID)){
    string sText = "I thank you. Here are some boots I made just for you. If you get more hides, please bring them to me.";
