...
void main()
{
    ...
    //Select a weapon to make///////////////////////////////////////////////////////
    {
        ...
        if (nRandom == 3)
        {
            SetLocalString(oPC, "enchant", "ench_bsword");
            SetLocalInt(oPC, "enchantwep", 1);
        }
        else if (nRandom == 4)
        {
            SetLocalString(oPC, "enchant", "ench_sickl");
            SetLocalInt(oPC, "enchantwep", 3);
        }
        else if (nRandom == 5)
        {
            SetLocalString(oPC, "enchant", "ench_gaxe");
            SetLocalInt(oPC, "enchantwep", 3);
        }
        else if (nRandom == 6)
        {
            SetLocalString(oPC, "enchant", "ench_haxe");
            SetLocalInt(oPC, "enchantwep", 3);
        }
        else if (nRandom == 7)
        {
            SetLocalString(oPC, "enchant", "ench_baxe");
            SetLocalInt(oPC, "enchantwep", 3);
        }
        else if (nRandom == 8)
        {
            SetLocalString(oPC, "enchant", "ench_dagger");
            SetLocalInt(oPC, "enchantwep", 1);
        }
        else if (nRandom == 9)
        {
            SetLocalString(oPC, "enchant", "ench_gsword");
            SetLocalInt(oPC, "enchantwep", 1);
        }
        else if (nRandom == 10)
        {
            SetLocalString(oPC, "enchant", "ench_lsword");
            SetLocalInt(oPC, "enchantwep", 1);
        }
        else if (nRandom == 11)
        {
            SetLocalString(oPC, "enchant", "ench_katana");
            SetLocalInt(oPC, "enchantwep", 1);
        }
        else if (nRandom == 12)
        {
            SetLocalString(oPC, "enchant", "ench_rapier");
            SetLocalInt(oPC, "enchantwep", 1);
        }
        else if (nRandom == 13)
        {
            SetLocalString(oPC, "enchant", "ench_scim");
            SetLocalInt(oPC, "enchantwep", 1);
        }
        else if (nRandom == 14)
        {
            SetLocalString(oPC, "enchant", "ench_ssword");
            SetLocalInt(oPC, "enchantwep", 1);
        }
        else if (nRandom == 15)
        {
            SetLocalString(oPC, "enchant", "ench_halb");
            SetLocalInt(oPC, "enchantwep", 3);
        }
        else if (nRandom == 16)
        {
            SetLocalString(oPC, "enchant", "ench_scyt");
            SetLocalInt(oPC, "enchantwep", 3);
        }
        else if (nRandom == 17)
        {
            SetLocalString(oPC, "enchant", "ench_spear");
            SetLocalInt(oPC, "enchantwep", 4);
        }
        else if (nRandom == 18)
        {
            SetLocalString(oPC, "enchant", "ench_kama");
            SetLocalInt(oPC, "enchantwep", 3);
        }
        else if (nRandom == 19)
        {
            SetLocalString(oPC, "enchant", "ench_kukri");
            SetLocalInt(oPC, "enchantwep", 3);
        }
        else if (nRandom == 20)
        {
            SetLocalString(oPC, "enchant", "ench_dmace");
            SetLocalInt(oPC, "enchantwep", 2);
        }
        else if (nRandom == 21)
        {
            SetLocalString(oPC, "enchant", "ench_daxe");
            SetLocalInt(oPC, "enchantwep", 3);
        }
        else if (nRandom == 22)
        {
            SetLocalString(oPC, "enchant", "ench_qstf");
            SetLocalInt(oPC, "enchantwep", 2);
        }
        else if (nRandom == 23)
        {
            SetLocalString(oPC, "enchant", "ench_dsword");
            SetLocalInt(oPC, "enchantwep", 1);
        }
        else if (nRandom == 24)
        {
            SetLocalString(oPC, "enchant", "ench_club");
            SetLocalInt(oPC, "enchantwep", 2);
        }
        else if (nRandom == 25)
        {
            SetLocalString(oPC, "enchant", "ench_lflail ");
            SetLocalInt(oPC, "enchantwep", 2);
        }
        else if (nRandom == 26)
        {
            SetLocalString(oPC, "enchant", "ench_hflail ");
            SetLocalInt(oPC, "enchantwep", 2);
        }
        else if (nRandom == 27)
        {
            SetLocalString(oPC, "enchant", "ench_hamm");
            SetLocalInt(oPC, "enchantwep", 2);
        }
        else if (nRandom == 28)
        {
            SetLocalString(oPC, "enchant", "ench_whamm");
            SetLocalInt(oPC, "enchantwep", 2);
        }
        else if (nRandom == 29)
        {
            SetLocalString(oPC, "enchant", "ench_mace");
            SetLocalInt(oPC, "enchantwep", 2);
        }
        else if (nRandom == 30)
        {
            SetLocalString(oPC, "enchant", "ench_mstar");
            SetLocalInt(oPC, "enchantwep", 2);
        }
        else if (nRandom == 31)
        {
        ...
        {
            SetLocalString(oPC, "enchant", "ench_whip");
            SetLocalInt(oPC, "enchantwep", 5);
        }
        else if (nRandom == 33)
        {
            SetLocalString(oPC, "enchant", "ench_sling");
            SetLocalInt(oPC, "enchantwep", 6);
        }
        else if (nRandom == 34)
        {
            SetLocalString(oPC, "enchant", "ench_sbow");
            SetLocalInt(oPC, "enchantwep", 7);
        }
        else if (nRandom == 35)
        {
            SetLocalString(oPC, "enchant", "ench_lbow");
            SetLocalInt(oPC, "enchantwep", 7);
        }
        else if (nRandom == 36)
        {
