    ...
    if ((!HasItem(oPC, sHide)) == FALSE)
    {
        ...
        else
        {
            ...
            if (GetLocalInt(oPC, "skil_craft") == 1)
            {
                ...
                itemproperty armSoak = ItemPropertyDamageReduction(
                    GetLocalInt(oPC, "enchdamred"),
                    GetLocalInt(oPC, "enchdamred1"));
            ...
            else if (GetLocalInt(oPC, "skil_craft") == 2)
            {
                ...
                itemproperty armSoak = ItemPropertyDamageReduction(
                    GetLocalInt(oPC, "enchdamred"),
                    GetLocalInt(oPC, "enchdamred1"));
                itemproperty propSavS1 = ItemPropertyBonusSavingThrowVsX(
                    IP_CONST_SAVEVS_FIRE,
                    GetLocalInt(oPC, "enchatmod"));
                itemproperty propSavS2 = ItemPropertyBonusSavingThrowVsX(
            ...
            else if (GetLocalInt(oPC, "skil_craft") == 8)
            {
                ...
                itemproperty imunSpell1 = ItemPropertySpellImmunitySpecific(
                    IP_CONST_IMMUNITYSPELL_BLINDNESS_AND_DEAFNESS);
            ...
            else if (GetLocalInt(oPC, "skil_craft") == 13)
            {
                ...
                itemproperty armSoak = ItemPropertyDamageReduction(
                    GetLocalInt(oPC, "enchdamred"),
                    GetLocalInt(oPC, "enchdamred1"));
                itemproperty propCast = ItemPropertyCastSpell(
                    IP_CONST_CASTSPELL_FLESH_TO_STONE_5,
                    GetLocalInt(oPC, "enchsptimes"));
                IPSafeAddItemProperty(oArmor, propACBon);
                if (d100(1) > nWow2) { IPSafeAddItemProperty(oArmor, propImmuMis); }
                if (d100(1) > nWow) { IPSafeAddItemProperty(oArmor, abilityMod); }
                if (d100(1) > nWow) { IPSafeAddItemProperty(oArmor, armSoak); }
            ...
            else if (GetLocalInt(oPC, "skil_craft") == 18)
            {
                ...
                itemproperty propSavS2 = ItemPropertyBonusSavingThrowVsX(
                    IP_CONST_SAVEVS_COLD,
                    GetLocalInt(oPC, "enchatmod"));
                itemproperty propSavS3 = ItemPropertyBonusSavingThrowVsX(
                    IP_CONST_SAVEVS_FIRE,
                    GetLocalInt(oPC, "enchatmod"));
                itemproperty propSavS4 = ItemPropertyBonusSavingThrowVsX(
                    IP_CONST_SAVEVS_POISON,
                    GetLocalInt(oPC, "enchatmod"));
                itemproperty propCast1 = ItemPropertyCastSpell(
                    IP_CONST_CASTSPELL_ANIMATE_DEAD_5,
                    GetLocalInt(oPC, "enchsptimes"));
                itemproperty propCast2 = ItemPropertyCastSpell(
                    IP_CONST_CASTSPELL_ANIMATE_DEAD_10,
                    GetLocalInt(oPC, "enchsptimes"));
                itemproperty propCast3 = ItemPropertyCastSpell(
                    IP_CONST_CASTSPELL_ANIMATE_DEAD_15,
                    GetLocalInt(oPC, "enchsptimes"));
                itemproperty propCast4 = ItemPropertyCastSpell(
                    IP_CONST_CASTSPELL_CREATE_UNDEAD_11,
                    GetLocalInt(oPC, "enchsptimes"));
                itemproperty propCast5 = ItemPropertyCastSpell(
                    IP_CONST_CASTSPELL_CREATE_UNDEAD_14,
                    GetLocalInt(oPC, "enchsptimes"));
                itemproperty propCast6 = ItemPropertyCastSpell(
                    IP_CONST_CASTSPELL_CREATE_UNDEAD_16,
                    GetLocalInt(oPC, "enchsptimes"));
                itemproperty propCast7 = ItemPropertyCastSpell(
                    IP_CONST_CASTSPELL_FIREBALL_5,
                    GetLocalInt(oPC, "enchsptimes"));
                itemproperty propCast8 = ItemPropertyCastSpell(
                    IP_CONST_CASTSPELL_FIREBALL_10,
                    GetLocalInt(oPC, "enchsptimes"));
                itemproperty propCast9 = ItemPropertyCastSpell(
                    IP_CONST_CASTSPELL_INVISIBILITY_3,
                    GetLocalInt(oPC, "enchsptimes"));
                itemproperty propCast10 = ItemPropertyCastSpell(
                    IP_CONST_CASTSPELL_IMPROVED_INVISIBILITY_7,
                    GetLocalInt(oPC, "enchsptimes"));
                itemproperty propCast11 = ItemPropertyCastSpell(
