...
//Fallen Knight
    ...
    GenerateLowTreasure(OBJECT_SELF);
        {int nRandom = d100(1);
            if (nRandom < 71){
                CreateItemOnObject("NW_AARCL006", OBJECT_SELF, 1);}  //Half Plate
            else if ((nRandom > 70) || (nRandom < 90)){
                CreateItemOnObject("NW_MAARCL052", OBJECT_SELF, 1);} //Half Plate +1
            else if (nRandom > 89){
                CreateItemOnObject("NW_MAARCL069", OBJECT_SELF, 1);}}//Half Plate +2
        {int nRandom = d100(1);
            if (nRandom < 71){
                CreateItemOnObject("NW_WSWGS001", OBJECT_SELF, 1);}  //Great Sword
            else if ((nRandom > 70) || (nRandom < 90)){
                CreateItemOnObject("NW_WSWMGS002", OBJECT_SELF, 1);} //Great Sword +1
            else if (nRandom > 89){
                CreateItemOnObject("NW_WSWMGS011", OBJECT_SELF, 1);}}//Great Sword +2
