...
if ((HasItem(oPC, "NW_IT_GEM001")) || (HasItem(oPC, "NW_IT_GEM007")) || (HasItem(oPC, "NW_IT_GEM002")) || (HasItem(oPC, "NW_IT_GEM004")) || (HasItem(oPC, "NW_IT_GEM014")) || (HasItem(oPC, "NW_IT_GEM003")) || (HasItem(oPC, "NW_IT_GEM015")) || (HasItem(oPC, "NW_IT_GEM013")) || (HasItem(oPC, "NW_IT_GEM011")) || (HasItem(oPC, "NW_IT_GEM010")) || (HasItem(oPC, "NW_IT_GEM008")) || (HasItem(oPC, "NW_IT_GEM009")) || (HasItem(oPC, "NW_IT_GEM005")) || (HasItem(oPC, "NW_IT_GEM006")) || (HasItem(oPC, "NW_IT_GEM012"))){
