        ...
        if (nRest == 0)
        {
            ...
            else if (GetTag(GetArea(oPC)) == "FortressOfZaltos2")
            {
                FloatingTextStringOnCreature(
                    "You don't feel that you can safely rest within this fortress.",
                    oPC,
                    TRUE);
            }
            ...
            {
                FloatingTextStringOnCreature(
                    "You don't feel that you can safely rest with all the creatures about.",
                    oPC,
                    TRUE);
            }
            ...
            {
                FloatingTextStringOnCreature(
                    "You cannot rest safely when an air elemental may appear at any moment.",
                    oPC,
                    TRUE);
            }
            ...
            {
                FloatingTextStringOnCreature(
                    "You cannot rest safely when a water elemental may appear at any moment.",
                    oPC,
                    TRUE);
            }
            ...
            {
                FloatingTextStringOnCreature(
                    "You cannot rest safely when a rock golem may appear at any moment.",
                    oPC,
                    TRUE);
            }
