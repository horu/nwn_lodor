        ...
        DelayCommand(2.0, DestroyObject(OBJECT_SELF));
        {
            ...
            if (nRandom == 1)
            {
                CreateObject(
                    ...
                    "ld_melagan_door",
                    GetLocation(GetWaypointByTag("melagan_wp_dr1")),
                    TRUE);
            }
            else if (nRandom == 2)
            {
                CreateObject(
                    OBJECT_TYPE_PLACEABLE,
                    "ld_melagan_door",
                    GetLocation(GetWaypointByTag("melagan_wp_dr2")),
                    TRUE);
            }
            else if (nRandom == 3)
            {
                CreateObject(
                    OBJECT_TYPE_PLACEABLE,
                    "ld_melagan_door",
                    GetLocation(GetWaypointByTag("melagan_wp_dr3")),
                    TRUE);
            }
            else if (nRandom == 4)
            {
                CreateObject(
                    OBJECT_TYPE_PLACEABLE,
                    "ld_melagan_door",
                    GetLocation(GetWaypointByTag("melagan_wp_dr4")),
                    TRUE);
            }
            else if (nRandom == 5)
            {
                CreateObject(
                    OBJECT_TYPE_PLACEABLE,
                    "ld_melagan_door",
                    GetLocation(GetWaypointByTag("melagan_wp_dr5")),
                    TRUE);
            }
            else if (nRandom == 6)
            {
                CreateObject(
                    OBJECT_TYPE_PLACEABLE,
                    "ld_melagan_door",
                    GetLocation(GetWaypointByTag("melagan_wp_dr6")),
                    TRUE);
            }
            else if (nRandom == 7)
            {
                CreateObject(
                    OBJECT_TYPE_PLACEABLE,
                    "ld_melagan_door",
                    GetLocation(GetWaypointByTag("melagan_wp_dr7")),
                    TRUE);
            }
            else if (nRandom == 8)
            {
                CreateObject(
                    OBJECT_TYPE_PLACEABLE,
                    "ld_melagan_door",
                    GetLocation(GetWaypointByTag("melagan_wp_dr8")),
                    TRUE);
            }
            else if (nRandom == 9)
            {
                CreateObject(
                    OBJECT_TYPE_PLACEABLE,
                    "ld_melagan_door",
                    GetLocation(GetWaypointByTag("melagan_wp_dr9")),
                    TRUE);
            }
            else if (nRandom == 10)
            {
                CreateObject(
                    OBJECT_TYPE_PLACEABLE,
                    "ld_melagan_door",
                    GetLocation(GetWaypointByTag("melagan_wp_dr10")),
                    TRUE);
            }
        }
    }
